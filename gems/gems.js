...
var GEMS = (function () {
    ...
    const event = async function(name, options={displayAll:true}) {
        let result;
        try {
            if (LOCALTEST) {
                if (--_count === 0) {
